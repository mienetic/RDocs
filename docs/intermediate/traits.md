...
::: pitfall
**The Orphan Rule**
คุณไม่สามารถ Implement External Trait ให้กับ External Type ได้!
อย่างน้อย **Trait** หรือ **Type** ต้องอยู่ใน Crate ของคุณเอง
(เช่น: คุณ `impl Display` ให้ `Vec` ไม่ได้ เพราะทั้งคู่มาจาก std)
:::
